    ...
    <div class="col-md-12">
        <div class="panel panel-primary">
          <div class="panel-heading">
            ...
            <div class="col-sm-3">
                <a href="table.php" class="amar_btn"> <i class="fa fa-plus-square"></i> Manage Student</a>
            </div>
          ...
          <div class="panel-body">
            <form class="form-horizontal">
              <div class="form-group">
                <label for="inputEmail3" class="col-sm-3 control-label">Student Name<span class="req_span">*</span></label>
                <div class="col-sm-8">
                  <input type="text" class="form-control" id="inputEmail3" placeholder="">
                </div>
              </div>
              <div class="form-group">
                <label for="inputEmail3" class="col-sm-3 control-label">Student Email<span class="req_span">*</span></label>
                <div class="col-sm-8">
                ...
                <div class="col-sm-8">
                   <div class="checkbox">
                      <label>
                       ...
                       <label>
                        <input type="checkbox" value="Travel"> Traveling
                      </label>
                    </div>
                </div>
              </div>
              <div class="form-group">
                <label for="comment" class="col-sm-3 control-label">Address</label>
                <div class="col-sm-8">
